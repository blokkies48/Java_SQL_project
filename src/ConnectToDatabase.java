...
// SQL used to create main projects table
// create table project
// (id int primary key auto_increment,project_name varchar(50),
// engineer_id int, manager_id int,
// architect_id int, customer_id int, short_desc varchar(500),
// is_finalized int, start_date varchar(50),
// due_date varchar(50),  end_date varchar(50));
